...
@Component({
    ...
    template: `<div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                ...
                <span class="text-primary font-medium">{{ 'dashboard.stats.newOrders' | translate: {count: '24'} }} </span>
                <span class="text-muted-color">{{ 'dashboard.stats.sinceLastVisit' | translate }}</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                ...
                <span class="text-muted-color">{{ 'dashboard.stats.sinceLastWeek' | translate }}</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                ...
                <span class="text-muted-color">{{ 'dashboard.stats.newlyRegistered' | translate }}</span>
            </div>
        </div>
        <div class="col-span-12 lg:col-span-6 xl:col-span-3">
            <div class="card mb-0">
                <div class="flex justify-between mb-4">
                    <div>
                        ...
                        <div class="text-surface-900 dark:text-surface-0 font-medium text-xl">{{ 'dashboard.stats.unread' | translate: {count: '152'} }}</div>
                    </div>
