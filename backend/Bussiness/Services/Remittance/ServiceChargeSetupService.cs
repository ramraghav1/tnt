...
{
    public interface IServiceChargeSetupService
    {
    ...
    public class ServiceChargeSetupService : IServiceChargeSetupService
    {
        private readonly IServiceChargeSetupRepository _repository;
        private readonly IMapper _mapper;

        public ServiceChargeSetupService(IServiceChargeSetupRepository repository, IMapper mapper)
        {
        ...
        {
            var dto = _mapper.Map<Repository.DataModels.Remittance.ServiceChargeSetupDTO.CreateSetupRequest>(request);
        ...
        {
            var dto = _mapper.Map<Repository.DataModels.Remittance.ServiceChargeSetupDTO.UpdateSetupRequest>(request);
        ...
        {
            var dto = _mapper.Map<Repository.DataModels.Remittance.ServiceChargeSetupDTO.CalculateChargeRequest>(request);
