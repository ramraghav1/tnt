...
{
    [ApiController]
    [Route("api/clinic/tenants/{tenantId}/patients")]
    public class PatientsController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Create(long tenantId, [FromBody] CreatePatientRequest request)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(long tenantId, long id, [FromBody] UpdatePatientRequest request)
        {
