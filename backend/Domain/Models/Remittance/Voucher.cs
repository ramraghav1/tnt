...
namespace Domain.Models.Remittance
{
    public class Voucher
    {
        ...
        {
            public string EntityType { get; set; } = string.Empty;   // AGENT or BRANCH
            public long? AgentId { get; set; }
            public long? BranchId { get; set; }
            public long? AgentAccountId { get; set; }
            public decimal Amount { get; set; }
            public string Mode { get; set; } = string.Empty;         // CR or DR
            public string ReferenceType { get; set; } = string.Empty; // DEPOSIT, WITHDRAWAL, ADJUSTMENT, SEND, PAYOUT
