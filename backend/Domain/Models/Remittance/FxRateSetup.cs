...
namespace Domain.Models.Remittance
{
    public class FxRateSetup
    {
        ...
        public class CreateFxRateRequest
        {
            ...
            public string? MarginType { get; set; }     // 'Flat' or 'Percentage'
        ...
        // ===========================
        // Response (detail — same as list for now, extensible)
        // ===========================
        ...
        // ===========================
        // Convert (utility request/response)
        // ===========================
